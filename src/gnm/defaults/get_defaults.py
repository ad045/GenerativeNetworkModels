...
def get_distance_matrix(
    ...
    distance_matrix = torch.load(
        ...
        Path("/Users/adrian/Documents/01_projects/14_4D_lab/src/imported_libraries/GenerativeNetworkModels_2/src/gnm/defaults/distance_matrices/AAL_DISTANCES.pt"),
        map_location=device,
        weights_only=True,
    )
...
def get_binary_network(
    ...
    binary_networks = torch.load(
        ...
        "/Users/adrian/Documents/01_projects/14_4D_lab/src/imported_libraries/GenerativeNetworkModels_2/src/gnm/defaults/binary_networks/CALM_BINARY_CONSENSUS.pt", 
        map_location=device,
        weights_only=True,
    )
